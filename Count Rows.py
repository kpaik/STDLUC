...
import pandas as pd
import glob
os.chdir("J:\EPPR\PopProgram\Projects\LUCA 2020 Prep\MAGIS L3 Updates\Assessor Data\Excel versions\Suffolk")
path = "J:\EPPR\PopProgram\Projects\LUCA 2020 Prep\MAGIS L3 Updates\Assessor Data\Excel versions\Suffolk"
...
combined.to_csv("Suffolk County.csv", columns = headers, index=False)
